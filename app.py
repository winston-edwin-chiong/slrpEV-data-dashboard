...
# today's date
today_date = get_last_days_datetime(7)
...
app.layout = html.Div([
    html.Div([
        dcc.DatePickerRange(
            id="date_time_picker",
            clearable=True,
            start_date=today_date, # placeholder, no new data yet
        ...
        dcc.Dropdown(
            ...
            options=[
                ...
                {'label':'Average Power Demand', 'value':'power_demand_W'},
    ...
    html.Div([
        dcc.Interval(
            ...
            interval=120*1000, # update every 5 minutes 
            n_intervals=0,
        ),
        html.Div(
...
def jump_to_present(button_press):
    return today_date, None # placeholder, no new data yet
